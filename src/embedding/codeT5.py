...
class CodeT5PlusEmbedderCache(Embedder):
    """Transformers-backed embedder that satisfies the Embedder protocol but does caching."""
    ...
    def embed_test_cases(
        ...
        return self._embed_test_cases_cache(test_cases, seed)
